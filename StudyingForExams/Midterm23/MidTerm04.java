public class Midterm04 {
    ...
    public void setManufacture(String manufacture) {
        if(this.manufacture == null) this.manufacture = manufacture;
        else System.out.println("[error] Maker can't be changed after production");
    }
    public static int getNumberOfCar() {return numberOfCar;}

    public static void ShowNumberOfCar() {System.out.println("Cumulative production : " + numberOfCar); }
    ...
    public static void main(String[] args) {
        ...
        int num = Midterm04.getNumberOfCar();
